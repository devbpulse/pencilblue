...
describe('Util', function() {
    ...
    describe('Util.inherits', function() {
        ...
        Type1.staticFunc2 = function staticFunc2(){};
        Type1.prototype.get = function get(){var y = 1;};
        Type1.prototype.set = function set(){var z = 3;};

        it('should throw an error when null is passed for the first type', function() {

            util.inherits.bind(null, null, Type1).should.throwError();
        });
        ...
        describe('Inherits called directly after prototype declaration', function() {

            //functions delcared here for reuse in assertions
            var staticFuncFor2 = function(){var x = 2;};
            var getAll = function getAll(){ var k = 9; };

            //declare type 2 that will inherit from type 1
            function Type2(){}
            ...
            Type2.prototype.get = function getOverride(){var j = 8;};
            Type2.prototype.getAll = getAll;

            it('should cause no changes to Type1', function() {
            ...
            it('should declare a property super_ that matches the constructor of Type1', function() {
                Type2.super_.should.eql(Type1);
            });

            it('should keep static properties of the inheriting type', function() {
                Type2.PROP.should.eql("def");
            });

            it('should keep static functions of the inheriting type', function() {
                //static functions of the inheriting type should remain in tact
            ...
            it('prototype functions of the inheriting type that do not exist on the super prototype should remain in tact', function() {
                Type2.prototype.getAll.should.eql(getAll);
            });

            it('prototype functions of the super type that are not implemented by the inheriting type should be inherited', function() {
                Type2.prototype.set.should.eql(Type1.prototype.set);
            });

            it('prototype functions of the inheriting type should take precedence', function() {
                Type2.prototype.get.should.eql(Type2.prototype.get);
            });
        });

        describe('Inherits called after prototype declaration and prototype assignment', function() {

            //functions delcared here for reuse in assertions
            var staticFuncFor3 = function(){var x = 2;};
            var getAll = function getAll(){ var k = 9; };
            ...
            //declare properties and functions
            Type3.PROP = 'def';
            Type3.staticFunc = staticFuncFor3;
            Type3.prototype.get = function getOverride(){var j = 8;};
            Type3.prototype.getAll = getAll;

            //perform inheritance
            util.inherits(Type3, Type1);

            it('should keep static properties of the super type', function() {
                Type3.PROP.should.eql("def");
            });

            it('static functions of the inheriting type should remain in tact', function() {
