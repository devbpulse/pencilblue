...
const UrlUtils = require('../../lib/utils/urlUtils');
     ...
     * TODO [1.0] remove onRenderComplete call
     * @deprecated
    ...
    RequestHandler.prototype.getRoute = function(path) {
        ...
        var route   = RouteService.getStatic(path);
        if (!_.isNil(route)) {
     ...
     * request
     * TODO [1.0] remove.  Developers should use the middleware functionality
     * @deprecated
    ...
    /**
     * TODO [1.0] Remove after serveError is patched
     * @deprecated
    ...
    RequestHandler.prototype.checkSystemSetup = function(context, cb) {
        ...
        SettingServiceFactory.getService(Configuration.active.settings.use_memory, Configuration.active.settings.use_cache, SiteUtils.GLOBAL_SITE)
