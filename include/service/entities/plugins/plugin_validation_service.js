...
class PluginValidationService {
     ...
     * @param {function} cb
     */
    validateDescription(plugin, opts, cb) {
        var err = null;
     ...
     * @param {function} cb
     */
    validateVersion(plugin, opts, cb) {
        var err = null;
     ...
     * @param {function} cb
     */
    validatePbVersionCompatibility(plugin, opts, cb) {
        var err = null;
     ...
     * @param {function} cb
     */
    validateContributor(contributor, context, cb) {
        var err = null;
     ...
     * @param {function} cb
     */
    validateSettings(plugin, opts, cb) {
     ...
     * @param {function} cb
     */
    validateSetting(setting, context, cb) {
     ...
     * @param {function} cb
     */
    validatePermissions(plugin, opts, cb) {
     ...
     * @param {function} cb
     */
    validateMainModule(plugin, opts, cb) {
        var err = null;
     ...
     * @param {function} cb
     */
    validateContentTemplates(plugin, opts, cb) {
     ...
     * @param {function} cb
     */
    validateDependencies(plugin, opts, cb) {
     ...
     * @returns {Function}
     */
    static getResultReducer(cb, existingErrors) {
