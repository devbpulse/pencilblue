...
var MediaServiceV2 = require('./media_service_v2');
var TaskUtils = require('../../../../lib/utils/taskUtils');
var TopicService = require('../topic_service');
        ...
        var tasks = {
            ...
            thumbnail: function(callback) {
                ...
                var mOpts = {
                    ...
                    where: DAO.getIdWhere(content.thumbnail)
                };
                var mediaService = new MediaServiceV2({ site: self.site, onlyThisSite: self.onlyThisSite });
                mediaService.getSingle(mOpts, function(err, media) {
                    if (media.isFile) {
                        media.location = UrlUtils.createSystemUrl(media.location);
                    }
...
module.exports = ContentObjectService;
